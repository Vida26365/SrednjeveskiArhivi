...
const DETECTION_MODEL_PATH: Asset = asset!("/assets/models/text-detection.rten");
const RECOGNITION_MODEL_PATH: Asset = asset!("/assets/models/text-recognition.rten");
...
pub fn main() -> Result<(), Box<dyn Error>> {
    let img_pot = "zapisi/jpgji/GZL I-1 (1243 april 13)-1/1.jpg";
    // let args = parse_args()?;
